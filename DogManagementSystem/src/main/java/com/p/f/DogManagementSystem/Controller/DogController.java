...
//@authorS555317
package com.p.f.DogManagementSystem.Controller;
...
import com.p.f.DogManagementSystem.Models.Trainer;
import com.p.f.DogManagementSystem.repository.DogRepository;
import com.p.f.DogManagementSystem.repository.TrainerRepository;
